...
const App = () => {
  ...
  return (
    <div className='flex items-center justify-center h-screen gap-2'>
      <TextField id='outlined-basic' label="Name" variant="outlined" inputRef={valRef} />
      <Button variant='outlined' size="large" onClick={userInput}>click me</Button>
      <div>
        {title}
      </div>
    </div>
